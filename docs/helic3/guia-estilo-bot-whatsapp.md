...
**Insumo para:** configuración de los agentes desde el Panel de Agentes IA
...
> **Vigencia.** Foto del bot real entre enero y julio de 2026. Las menciones al "agente actual" describen el estado de agosto de 2026. Horarios, teléfono, menú y paquete de datos de garantía son valores de negocio: su fuente de verdad son los catálogos y parámetros en BD, no este documento. No se copian literales en prompts ni en código.
...
> "Mucho gusto mi nombre es [nombre], soy la asesora encargada de atender y gestionar tu
