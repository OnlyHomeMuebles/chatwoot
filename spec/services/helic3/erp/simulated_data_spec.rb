...
RSpec.describe Helic3::Erp::SimulatedData do
  it 'tiene varios clientes con cédula única, del tipo del contrato' do
    expect(described_class.customers.values).to all(be_a(Helic3::Erp::Customer))
  ...
  it 'encuentra una factura por su número' do
    expect(described_class.invoice('FV-1050')).to be_a(Helic3::Erp::Invoice)
