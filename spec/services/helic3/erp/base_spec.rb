...
RSpec.describe Helic3::Erp::Base do
  ...
  describe 'objetos de valor del contrato' do
    it 'Customer expone los datos del cliente (email/teléfono opcionales)' do
      customer = Helic3::Erp::Customer.new(cedula: '1032456789', nombre: 'Ana Ruiz')
    ...
    it 'Invoice expone los datos de la factura (items por defecto vacío)' do
      invoice = Helic3::Erp::Invoice.new(numero: 'F-001', fecha: '2026-07-01', total: 100_000, saldo: 0, estado: 'pagada')
    ...
    it 'AccountStatement expone el saldo y la cartera del cliente' do
      statement = Helic3::Erp::AccountStatement.new(cedula: '1032456789', saldo_total: 250_000, facturas_pendientes: 2, al_dia: false)
