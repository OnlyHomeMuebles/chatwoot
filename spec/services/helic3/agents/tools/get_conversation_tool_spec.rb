...
RSpec.describe Helic3::Agents::Tools::GetConversationTool do
  ...
  it 'devuelve un mensaje de error legible si la API falla' do
    allow(chatwoot).to receive(:conversation_messages).and_raise(Helic3::ChatwootClient::ApiError, 'boom')
