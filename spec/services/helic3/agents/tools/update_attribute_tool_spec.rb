...
RSpec.describe Helic3::Agents::Tools::UpdateAttributeTool do
  ...
  it 'devuelve un mensaje de error legible si la API falla' do
    allow(chatwoot).to receive(:update_custom_attributes).and_raise(Helic3::ChatwootClient::ApiError, 'boom')
