...
class OnlyHome::Copilot::SuggestionService
  ...
  # @param chatwoot_client [OnlyHome::ChatwootClient, nil] injectable (defaults from ENV)
  ...
  def runner
    @runner ||= Agents::Runner.with_agents(OnlyHome::Copilot::Agent.build(model: @model))
  end
end
