...
module Helic3::Agents::CatalogoHerramientas
  HERRAMIENTAS = [
    ...
    { clave: 'registrar_datos_cliente', etiqueta: 'Registrar datos del cliente',
      ayuda: 'Guarda en el expediente los datos que el cliente confirma en el chat (cedula, direccion, ciudad, factura).',
      escribe_expediente: true,
      clase: 'Helic3::Agents::Tools::RegistrarDatosClienteTool' },
