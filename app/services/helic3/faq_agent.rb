...
class Helic3::FaqAgent
  INSTRUCTIONS = <<~INST.freeze
    ...
    #{Helic3::KnowledgeBase::EMPRESA}

    #{Helic3::KnowledgeBase::CATALOGO}

    #{Helic3::KnowledgeBase::COMBOS}

    #{Helic3::KnowledgeBase::TIENDAS}

    #{Helic3::KnowledgeBase::POLITICAS}

    #{Helic3::KnowledgeBase::FAQ}
