...
- **Código:** `app/services/helic3/`
- **Pruebas:** `spec/services/helic3/`
...
```
$ bundle exec rspec spec/services/helic3/
...
| **Documento con el rol y los límites** de cada agente | `app/services/helic3/README.md` (tabla de rol, fronteras y contexto dinámico por agente) |
...
bundle exec rspec spec/services/helic3/ --format documentation

# Estilo
bundle exec rubocop app/services/helic3/ \
                    spec/services/helic3/
```
