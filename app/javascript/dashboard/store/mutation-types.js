export default {
  ...
  // Tickets
  SET_TICKET_UI_FLAG: 'SET_TICKET_UI_FLAG',
  SET_TICKETS: 'SET_TICKETS',
  ADD_TICKET: 'ADD_TICKET',
  EDIT_TICKET: 'EDIT_TICKET',
  DELETE_TICKET: 'DELETE_TICKET',
  SET_TICKET_CATALOGOS: 'SET_TICKET_CATALOGOS',
  SET_PQR_INBOX: 'SET_PQR_INBOX',
  SET_PQR_INBOX_META: 'SET_PQR_INBOX_META',
  SET_PQR_CURRENT: 'SET_PQR_CURRENT',
  SET_PQR_DECISIONES: 'SET_PQR_DECISIONES',
  SET_PQR_CONTADORES: 'SET_PQR_CONTADORES',
  SET_PQR_INBOX_UI_FLAG: 'SET_PQR_INBOX_UI_FLAG',
  SET_PQR_DOCUMENTOS: 'SET_PQR_DOCUMENTOS',
  ADD_PQR_DOCUMENTO: 'ADD_PQR_DOCUMENTO',
  SET_PQR_ADMIN_UI_FLAG: 'SET_PQR_ADMIN_UI_FLAG',
  SET_PQR_CATALOGO: 'SET_PQR_CATALOGO',
  SET_PQR_PARAMETROS: 'SET_PQR_PARAMETROS',
